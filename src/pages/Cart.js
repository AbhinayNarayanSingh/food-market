...
const Cart = () => {
  ...
  return (
    <div className="cart-container">
      <PageHeading h2="Checkout" p="Just one step away" />
      ...
      <section className="transaction-detail">
        <p>
          <span>Sub Total</span> <span>850.00 INR</span>
        </p>
        <p>
          <span>Delivery</span> <span>50.00 INR</span>
        </p>
        <p>
          <span>Tax</span> <span>90.00 INR</span>
        </p>
        <h2>
          <span>Total Price</span>
          <span>990.00 INR</span>
        </h2>
      </section>
      ...
      <section className="transaction-detail">
        ...
        <p>
          <span>Phone No.</span> <span>{customer.contact}</span>
        </p>
        <p>
          <span>Address</span> <span>{customer.building}</span>
        </p>
        <p>
          <span>City</span> <span>{customer.city}</span>
        </p>
        <p>
          <span>State</span> <span>{customer.state}</span>
        </p>
        <p>
          <span>Pincode</span> <span>{customer.pin}</span>
        </p>
      </section>
